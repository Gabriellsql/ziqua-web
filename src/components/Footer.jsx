      ...
      <div className="max-w-6xl mx-auto px-12 pt-8 pb-12">
        ...
        <div className="flex gap-16 mb-14">
          ...
          {links.map((col, i) => (
            ...
            >
              <p className="text-xs font-black mb-4 tracking-widest uppercase"
                style={{ color: '#378ADD' }}>
                {col.title}
              </p>
                ...
                {col.items.map((item) => (
                  <li key={item}>
                    <motion.a
                      ...
                      className="text-sm"
                      style={{ color: 'rgba(255,255,255,0.50)', textDecoration: 'none', display: 'block' }}
                    >
                      {item}
                    </motion.a>
                  </li>
          ...
          >
            ...
            <motion.button
              ...
              style={{ background: '#185FA5', boxShadow: '0 4px 14px rgba(24,95,165,0.4)' }}
            >
              Solicitar demo →
            </motion.button>
          </motion.div>
